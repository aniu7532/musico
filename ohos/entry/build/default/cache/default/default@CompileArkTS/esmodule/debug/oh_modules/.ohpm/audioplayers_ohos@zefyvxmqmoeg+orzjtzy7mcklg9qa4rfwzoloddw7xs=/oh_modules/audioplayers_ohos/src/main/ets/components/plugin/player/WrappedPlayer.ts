...
import { ReleaseMode } from "@package:pkg_modules/.ohpm/audioplayers_ohos@zefyvxmqmoeg+orzjtzy7mcklg9qa4rfwzoloddw7xs=/pkg_modules/audioplayers_ohos/src/main/ets/components/plugin/ReleaseMode";
import { PlayerMode } from "@package:pkg_modules/.ohpm/audioplayers_ohos@zefyvxmqmoeg+orzjtzy7mcklg9qa4rfwzoloddw7xs=/pkg_modules/audioplayers_ohos/src/main/ets/components/plugin/PlayerMode";
import type Source from '../source/Source';
import FocusManager from "@package:pkg_modules/.ohpm/audioplayers_ohos@zefyvxmqmoeg+orzjtzy7mcklg9qa4rfwzoloddw7xs=/pkg_modules/audioplayers_ohos/src/main/ets/components/plugin/player/FocusManager";
import type Player from './Player';
import type { Context } from "@ohos:abilityAccessCtrl";
import type audio from "@ohos:multimedia.audio";
import SoundPoolPlayer from "@package:pkg_modules/.ohpm/audioplayers_ohos@zefyvxmqmoeg+orzjtzy7mcklg9qa4rfwzoloddw7xs=/pkg_modules/audioplayers_ohos/src/main/ets/components/plugin/player/SoundPoolPlayer";
import type { SoundPoolManager } from "@package:pkg_modules/.ohpm/audioplayers_ohos@zefyvxmqmoeg+orzjtzy7mcklg9qa4rfwzoloddw7xs=/pkg_modules/audioplayers_ohos/src/main/ets/components/plugin/player/SoundPoolPlayer";
import MediaPlayerPlayer from "@package:pkg_modules/.ohpm/audioplayers_ohos@zefyvxmqmoeg+orzjtzy7mcklg9qa4rfwzoloddw7xs=/pkg_modules/audioplayers_ohos/src/main/ets/components/plugin/player/MediaPlayerPlayer";
export default class WrappedPlayer {
    ...
    handleError(errorCode?: string, errorMessage?: string, errorDetails?: any) {
