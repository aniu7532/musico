...
export default class FlutterApplicationInfo {
    ...
    //是否是profile模式
    isProfile: boolean;
    constructor(aotSharedLibraryName: string | null, vmSnapshotData: string | null, isolateSnapshotData: string | null, flutterAssetsDir: string | null, domainNetworkPolicy: string | null, nativeLibraryDir: string, automaticallyRegisterPlugins: boolean) {
