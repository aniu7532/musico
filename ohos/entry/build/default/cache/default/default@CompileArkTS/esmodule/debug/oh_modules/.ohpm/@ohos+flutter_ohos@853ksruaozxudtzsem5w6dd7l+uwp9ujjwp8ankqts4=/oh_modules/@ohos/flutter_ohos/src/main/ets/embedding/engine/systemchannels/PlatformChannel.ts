...
export class SystemChromeStyle {
    ...
    constructor(statusBarColor: number | null, statusBarIconBrightness: Brightness | null, systemStatusBarContrastEnforced: boolean | null, systemNavigationBarColor: number | null, systemNavigationBarIconBrightness: Brightness | null, systemNavigationBarDividerColor: number | null, systemNavigationBarContrastEnforced: boolean | null) {
