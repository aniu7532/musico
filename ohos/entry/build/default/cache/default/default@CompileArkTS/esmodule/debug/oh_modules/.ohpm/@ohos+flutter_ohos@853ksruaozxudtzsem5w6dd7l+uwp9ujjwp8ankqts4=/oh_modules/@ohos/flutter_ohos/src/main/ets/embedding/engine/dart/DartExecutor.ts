...
export default class DartExecutor implements BinaryMessenger {
    ...
    executeDartEntrypoint(dartEntrypoint: DartEntrypoint, dartEntrypointArgs?: string[]): void {
        ...
        try {
            ...
            this.flutterNapi.runBundleAndSnapshotFromLibrary(dartEntrypoint.pathToBundle, dartEntrypoint.dartEntrypointFunctionName, dartEntrypoint.dartEntrypointLibrary, this.assetManager, dartEntrypointArgs ?? []);
            this.isApplicationRunning = true;
        }
        finally {
    ...
    executeDartCallback(dartCallback: DartCallback): void {
        ...
        try {
            ...
            this.flutterNapi.runBundleAndSnapshotFromLibrary(dartCallback.pathToBundle, dartCallback.callbackHandle.callbackName, dartCallback.callbackHandle.callbackLibraryPath, dartCallback.resourceManager, []);
            this.isApplicationRunning = true;
        }
        finally {
...
export class DartEntrypoint {
    ...
    constructor(pathToBundle: string, dartEntrypointLibrary: string, dartEntrypointFunctionName: string) {
...
export class DartCallback {
    ...
    constructor(resourceManager: resourceManager.ResourceManager, pathToBundle: string, callbackHandle: FlutterCallbackInformation) {
